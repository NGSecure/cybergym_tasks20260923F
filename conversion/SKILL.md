...
> **This repo (cybergym_tasks20260923F).** The prime bundles live under
> `cybergym_tasks20260923F/`, and the conversion toolkit is a self-contained copy under
...
From the `cybergym_tasks20260923F/` directory (where the bundles are):

```bash
cd cybergym_tasks20260923F
# one bundle
